...
`;function _t(e,...t){const o=T.locate(e);t.forEach((t=>{Object.getOwnPropertyNames(t.prototype).forEach((o=>{"constructor"!==o&&Object.defineProperty(e.prototype,o,Object.getOwnPropertyDescriptor(t.prototype,o))}));T.locate(t).forEach((e=>o.push(e)))}))}var Mt;!function(e){e[e.alt=18]="alt",e[e.arrowDown=40]="arrowDown",e[e.arrowLeft=37]="arrowLeft",e[e.arrowRight=39]="arrowRight",e[e.arrowUp=38]="arrowUp",e[e.back=8]="back",e[e.backSlash=220]="backSlash",e[e.break=19]="break",e[e.capsLock=20]="capsLock",e[e.closeBracket=221]="closeBracket",e[e.colon=186]="colon",e[e.colon2=59]="colon2",e[e.comma=188]="comma",e[e.ctrl=17]="ctrl",e[e.delete=46]="delete",e[e.end=35]="end",e[e.enter=13]="enter",e[e.equals=187]="equals",e[e.equals2=61]="equals2",e[e.equals3=107]="equals3",e[e.escape=27]="escape",e[e.forwardSlash=191]="forwardSlash",e[e.function1=112]="function1",e[e.function10=121]="function10",e[e.function11=122]="function11",e[e.function12=123]="function12",e[e.function2=113]="function2",e[e.function3=114]="function3",e[e.function4=115]="function4",e[e.function5=116]="function5",e[e.function6=117]="function6",e[e.function7=118]="function7",e[e.function8=119]="function8",e[e.function9=120]="function9",e[e.home=36]="home",e[e.insert=45]="insert",e[e.menu=93]="menu",e[e.minus=189]="minus",e[e.minus2=109]="minus2",e[e.numLock=144]="numLock",e[e.numPad0=96]="numPad0",e[e.numPad1=97]="numPad1",e[e.numPad2=98]="numPad2",e[e.numPad3=99]="numPad3",e[e.numPad4=100]="numPad4",e[e.numPad5=101]="numPad5",e[e.numPad6=102]="numPad6",e[e.numPad7=103]="numPad7",e[e.numPad8=104]="numPad8",e[e.numPad9=105]="numPad9",e[e.numPadDivide=111]="numPadDivide",e[e.numPadDot=110]="numPadDot",e[e.numPadMinus=109]="numPadMinus",e[e.numPadMultiply=106]="numPadMultiply",e[e.numPadPlus=107]="numPadPlus",e[e.openBracket=219]="openBracket",e[e.pageDown=34]="pageDown",e[e.pageUp=33]="pageUp",e[e.period=190]="period",e[e.print=44]="print",e[e.quote=222]="quote",e[e.scrollLock=145]="scrollLock",e[e.shift=16]="shift",e[e.space=32]="space",e[e.tab=9]="tab",e[e.tilde=192]="tilde",e[e.windowsLeft=91]="windowsLeft",e[e.windowsOpera=219]="windowsOpera",e[e.windowsRight=92]="windowsRight"}(Mt||(Mt={}));const It="Enter",Vt="form-associated-proxy",Nt="ElementInternals",zt=Nt in window&&"setFormValue"in window[Nt].prototype,jt=new WeakMap;function qt(e){const t=class extends e{constructor(...e){super(...e),this.dirtyValue=!1,this.disabled=!1,this.proxyEventsToBlock=["change","click"],this.proxyInitialized=!1,this.required=!1,this.initialValue=this.initialValue||"",this.elementInternals||(this.formResetCallback=this.formResetCallback.bind(this))}static get formAssociated(){return zt}get validity(){return this.elementInternals?this.elementInternals.validity:this.proxy.validity}get form(){return this.elementInternals?this.elementInternals.form:this.proxy.form}get validationMessage(){return this.elementInternals?this.elementInternals.validationMessage:this.proxy.validationMessage}get willValidate(){return this.elementInternals?this.elementInternals.willValidate:this.proxy.willValidate}get labels(){if(this.elementInternals)return Object.freeze(Array.from(this.elementInternals.labels));if(this.proxy instanceof HTMLElement&&this.proxy.ownerDocument&&this.id){const e=this.proxy.labels,t=Array.from(this.proxy.getRootNode().querySelectorAll(`[for='${this.id}']`)),o=e?t.concat(Array.from(e)):t;return Object.freeze(o)}return s}valueChanged(e,t){this.dirtyValue=!0,this.proxy instanceof HTMLElement&&(this.proxy.value=this.value),this.currentValue=this.value,this.setFormValue(this.value),this.validate()}currentValueChanged(){this.value=this.currentValue}initialValueChanged(e,t){this.dirtyValue||(this.value=this.initialValue,this.dirtyValue=!1)}disabledChanged(e,t){this.proxy instanceof HTMLElement&&(this.proxy.disabled=this.disabled),f.queueUpdate((()=>this.classList.toggle("disabled",this.disabled)))}nameChanged(e,t){this.proxy instanceof HTMLElement&&(this.proxy.name=this.name)}requiredChanged(e,t){this.proxy instanceof HTMLElement&&(this.proxy.required=this.required),f.queueUpdate((()=>this.classList.toggle("required",this.required))),this.validate()}get elementInternals(){if(!zt)return null;let e=jt.get(this);return e||(e=this.attachInternals(),jt.set(this,e)),e}connectedCallback(){super.connectedCallback(),this.addEventListener("keypress",this._keypressHandler),this.value||(this.value=this.initialValue,this.dirtyValue=!1),this.elementInternals||(this.attachProxy(),this.form&&this.form.addEventListener("reset",this.formResetCallback))}disconnectedCallback(){this.proxyEventsToBlock.forEach((e=>this.proxy.removeEventListener(e,this.stopPropagation))),!this.elementInternals&&this.form&&this.form.removeEventListener("reset",this.formResetCallback)}checkValidity(){return this.elementInternals?this.elementInternals.checkValidity():this.proxy.checkValidity()}reportValidity(){return this.elementInternals?this.elementInternals.reportValidity():this.proxy.reportValidity()}setValidity(e,t,o){this.elementInternals?this.elementInternals.setValidity(e,t,o):"string"==typeof t&&this.proxy.setCustomValidity(t)}formDisabledCallback(e){this.disabled=e}formResetCallback(){this.value=this.initialValue,this.dirtyValue=!1}attachProxy(){var e;this.proxyInitialized||(this.proxyInitialized=!0,this.proxy.style.display="none",this.proxyEventsToBlock.forEach((e=>this.proxy.addEventListener(e,this.stopPropagation))),this.proxy.disabled=this.disabled,this.proxy.required=this.required,"string"==typeof this.name&&(this.proxy.name=this.name),"string"==typeof this.value&&(this.proxy.value=this.value),this.proxy.setAttribute("slot",Vt),this.proxySlot=document.createElement("slot"),this.proxySlot.setAttribute("name",Vt)),null===(e=this.shadowRoot)||void 0===e||e.appendChild(this.proxySlot),this.appendChild(this.proxy)}detachProxy(){var e;this.removeChild(this.proxy),null===(e=this.shadowRoot)||void 0===e||e.removeChild(this.proxySlot)}validate(e){this.proxy instanceof HTMLElement&&this.setValidity(this.proxy.validity,this.proxy.validationMessage,e)}setFormValue(e,t){this.elementInternals&&this.elementInternals.setFormValue(e,t||e)}_keypressHandler(e){if(e.key===It)if(this.form instanceof HTMLFormElement){const e=this.form.querySelector("[type=submit]");null==e||e.click()}}stopPropagation(e){e.stopPropagation()}};return R({mode:"boolean"})(t.prototype,"disabled"),R({mode:"fromView",attribute:"value"})(t.prototype,"initialValue"),R({attribute:"current-value"})(t.prototype,"currentValue"),R(t.prototype,"name"),R({mode:"boolean"})(t.prototype,"required"),m(t.prototype,"value"),t}class Ut extends Oe{}class Ht extends(qt(Ut)){constructor(){super(...arguments),this.proxy=document.createElement("input")}}class Gt extends Ht{constructor(){super(...arguments),this.handleClick=e=>{var t;this.disabled&&(null===(t=this.defaultSlottedContent)||void 0===t?void 0:t.length)<=1&&e.stopPropagation()},this.handleSubmission=()=>{if(!this.form)return;const e=this.proxy.isConnected;e||this.attachProxy(),"function"==typeof this.form.requestSubmit?this.form.requestSubmit(this.proxy):this.proxy.click(),e||this.detachProxy()},this.handleFormReset=()=>{var e;null===(e=this.form)||void 0===e||e.reset()},this.handleUnsupportedDelegatesFocus=()=>{var e;window.ShadowRoot&&!window.ShadowRoot.prototype.hasOwnProperty("delegatesFocus")&&(null===(e=this.$fastController.definition.shadowOptions)||void 0===e?void 0:e.delegatesFocus)&&(this.focus=()=>{this.control.focus()})}}formactionChanged(){this.proxy instanceof HTMLInputElement&&(this.proxy.formAction=this.formaction)}formenctypeChanged(){this.proxy instanceof HTMLInputElement&&(this.proxy.formEnctype=this.formenctype)}formmethodChanged(){this.proxy instanceof HTMLInputElement&&(this.proxy.formMethod=this.formmethod)}formnovalidateChanged(){this.proxy instanceof HTMLInputElement&&(this.proxy.formNoValidate=this.formnovalidate)}formtargetChanged(){this.proxy instanceof HTMLInputElement&&(this.proxy.formTarget=this.formtarget)}typeChanged(e,t){this.proxy instanceof HTMLInputElement&&(this.proxy.type=this.type),"submit"===t&&this.addEventListener("click",this.handleSubmission),"submit"===e&&this.removeEventListener("click",this.handleSubmission),"reset"===t&&this.addEventListener("click",this.handleFormReset),"reset"===e&&this.removeEventListener("click",this.handleFormReset)}validate(){super.validate(this.control)}connectedCallback(){var e;super.connectedCallback(),this.proxy.setAttribute("type",this.type),this.handleUnsupportedDelegatesFocus();const t=Array.from(null===(e=this.control)||void 0===e?void 0:e.children);t&&t.forEach((e=>{e.addEventListener("click",this.handleClick)}))}disconnectedCallback(){var e;super.disconnectedCallback();const t=Array.from(null===(e=this.control)||void 0===e?void 0:e.children);t&&t.forEach((e=>{e.removeEventListener("click",this.handleClick)}))}}_([R({mode:"boolean"})],Gt.prototype,"autofocus",void 0),_([R({attribute:"form"})],Gt.prototype,"formId",void 0),_([R],Gt.prototype,"formaction",void 0),_([R],Gt.prototype,"formenctype",void 0),_([R],Gt.prototype,"formmethod",void 0),_([R({mode:"boolean"})],Gt.prototype,"formnovalidate",void 0),_([R],Gt.prototype,"formtarget",void 0),_([R],Gt.prototype,"type",void 0),_([m],Gt.prototype,"defaultSlottedContent",void 0);class Wt{}_([R({attribute:"aria-expanded"})],Wt.prototype,"ariaExpanded",void 0),_([R({attribute:"aria-pressed"})],Wt.prototype,"ariaPressed",void 0),_t(Wt,it),_t(Gt,class{handleStartContentChange(){this.startContainer.classList.toggle("start",this.start.assignedNodes().length>0)}handleEndContentChange(){this.endContainer.classList.toggle("end",this.end.assignedNodes().length>0)}},Wt);class Qt{constructor(e,t){this.target=e,this.options=t,this.source=null}bind(e){const t=this.options.property;this.shouldUpdate=g.getAccessors(e).some((e=>e.name===t)),this.source=e,this.updateTarget(this.computeNodes()),this.shouldUpdate&&this.observe()}unbind(){this.updateTarget(s),this.source=null,this.shouldUpdate&&this.disconnect()}handleEvent(){this.updateTarget(this.computeNodes())}computeNodes(){let e=this.getNodes();return void 0!==this.options.filter&&(e=e.filter(this.options.filter)),e}updateTarget(e){this.source[this.options.property]=e}}class Yt extends Qt{constructor(e,t){super(e,t)}observe(){this.target.addEventListener("slotchange",this)}disconnect(){this.target.removeEventListener("slotchange",this)}getNodes(){return this.target.assignedNodes(this.options)}}function Kt(e){return"string"==typeof e&&(e={property:e}),new lt("fast-slotted",Yt,e)}function Zt(e,t){const o=[];let n="";const r=[];for(let s=0,i=e.length-1;s<i;++s){n+=e[s];let i=t[s];if(i instanceof Ee){const e=i.createBehavior();i=i.createCSS(),e&&r.push(e)}i instanceof x||i instanceof CSSStyleSheet?(""!==n.trim()&&(o.push(n),n=""),o.push(i)):n+=i}return n+=e[e.length-1],""!==n.trim()&&o.push(n),{styles:o,behaviors:r}}function Jt(e,...t){const{styles:o,behaviors:n}=Zt(e,t),r=x.create(o);return n.length&&r.withBehaviors(...n),r}let Xt;const eo=function(){if("boolean"==typeof Xt)return Xt;if("undefined"==typeof window||!window.document||!window.document.createElement)return Xt=!1,Xt;const e=document.createElement("style"),t=function(){const e=document.querySelector('meta[property="csp-nonce"]');return e?e.getAttribute("content"):null}();null!==t&&e.setAttribute("nonce",t),document.head.appendChild(e);try{e.sheet.insertRule("foo:focus-visible {color:inherit}",0),Xt=!0}catch(e){Xt=!1}finally{document.head.removeChild(e)}return Xt}()?"focus-visible":"focus";function to(e){const t=getComputedStyle(document.body),o=document.querySelector("body");if(o){const n=o.getAttribute("data-vscode-theme-kind");for(const[r,s]of e){let e=t.getPropertyValue(r).toString();if("vscode-high-contrast"===n)0===e.length&&s.name.includes("background")&&(e="transparent"),"button-icon-hover-background"===s.name&&(e="transparent");else if("vscode-high-contrast-light"===n){if(0===e.length&&s.name.includes("background"))switch(s.name){case"button-primary-hover-background":e="#0F4A85";break;case"button-secondary-hover-background":case"button-icon-hover-background":e="transparent"}}else"contrast-active-border"===s.name&&(e="transparent");s.setValueFor(o,e)}}}const oo=new Map;let no=!1;function ro(e,t){const o=Ze.create(e);if(t){if(t.includes("--fake-vscode-token")){t=`${t}-${"id"+Math.random().toString(16).slice(2)}`}oo.set(t,o)}return no||(!function(e){window.addEventListener("load",(()=>{new MutationObserver((()=>{to(e)})).observe(document.body,{attributes:!0,attributeFilter:["class"]}),to(e)}))}(oo),no=!0),o}ro("background","--vscode-editor-background").withDefault("#1e1e1e");const so=ro("border-width").withDefault(1),io=ro("contrast-active-border","--vscode-contrastActiveBorder").withDefault("#f38518"),ao=(ro("contrast-border","--vscode-contrastBorder").withDefault("#6fc3df"),ro("corner-radius").withDefault(0),ro("design-unit").withDefault(4)),co=ro("disabled-opacity").withDefault(.4),lo=ro("focus-border","--vscode-focusBorder").withDefault("#007fd4"),ho=ro("font-family","--vscode-font-family").withDefault("-apple-system, BlinkMacSystemFont, Segoe UI, Roboto, Helvetica, Arial, sans-serif, Apple Color Emoji, Segoe UI Emoji, Segoe UI Symbol"),uo=(ro("font-weight","--vscode-font-weight").withDefault("400"),ro("foreground","--vscode-foreground").withDefault("#cccccc")),fo=(ro("input-height").withDefault("26"),ro("input-min-width").withDefault("100px"),ro("type-ramp-base-font-size","--vscode-font-size").withDefault("13px")),bo=ro("type-ramp-base-line-height").withDefault("normal"),po=(ro("type-ramp-minus1-font-size").withDefault("11px"),ro("type-ramp-minus1-line-height").withDefault("16px"),ro("type-ramp-minus2-font-size").withDefault("9px"),ro("type-ramp-minus2-line-height").withDefault("16px"),ro("type-ramp-plus1-font-size").withDefault("16px"),ro("type-ramp-plus1-line-height").withDefault("24px"),ro("scrollbarWidth").withDefault("10px"),ro("scrollbarHeight").withDefault("10px"),ro("scrollbar-slider-background","--vscode-scrollbarSlider-background").withDefault("#79797966"),ro("scrollbar-slider-hover-background","--vscode-scrollbarSlider-hoverBackground").withDefault("#646464b3"),ro("scrollbar-slider-active-background","--vscode-scrollbarSlider-activeBackground").withDefault("#bfbfbf66"),ro("badge-background","--vscode-badge-background").withDefault("#4d4d4d"),ro("badge-foreground","--vscode-badge-foreground").withDefault("#ffffff"),ro("button-border","--vscode-button-border").withDefault("transparent")),go=ro("button-icon-background").withDefault("transparent"),mo=ro("button-icon-corner-radius").withDefault("5px"),vo=ro("button-icon-outline-offset").withDefault(0),yo=ro("button-icon-hover-background","--fake-vscode-token").withDefault("rgba(90, 93, 94, 0.31)"),wo=ro("button-icon-padding").withDefault("3px"),ko=ro("button-primary-background","--vscode-button-background").withDefault("#0e639c"),xo=ro("button-primary-foreground","--vscode-button-foreground").withDefault("#ffffff"),Co=ro("button-primary-hover-background","--vscode-button-hoverBackground").withDefault("#1177bb"),$o=ro("button-secondary-background","--vscode-button-secondaryBackground").withDefault("#3a3d41"),Po=ro("button-secondary-foreground","--vscode-button-secondaryForeground").withDefault("#ffffff"),So=ro("button-secondary-hover-background","--vscode-button-secondaryHoverBackground").withDefault("#45494e"),Do=ro("button-padding-horizontal").withDefault("11px"),To=ro("button-padding-vertical").withDefault("4px"),Ao=(ro("checkbox-background","--vscode-checkbox-background").withDefault("#3c3c3c"),ro("checkbox-border","--vscode-checkbox-border").withDefault("#3c3c3c"),ro("checkbox-corner-radius").withDefault(3),ro("checkbox-foreground","--vscode-checkbox-foreground").withDefault("#f0f0f0"),ro("list-active-selection-background","--vscode-list-activeSelectionBackground").withDefault("#094771"),ro("list-active-selection-foreground","--vscode-list-activeSelectionForeground").withDefault("#ffffff"),ro("list-hover-background","--vscode-list-hoverBackground").withDefault("#2a2d2e"),ro("divider-background","--vscode-settings-dropdownListBorder").withDefault("#454545"),ro("dropdown-background","--vscode-dropdown-background").withDefault("#3c3c3c"),ro("dropdown-border","--vscode-dropdown-border").withDefault("#3c3c3c"),ro("dropdown-foreground","--vscode-dropdown-foreground").withDefault("#f0f0f0"),ro("dropdown-list-max-height").withDefault("200px"),ro("input-background","--vscode-input-background").withDefault("#3c3c3c"),ro("input-foreground","--vscode-input-foreground").withDefault("#cccccc"),ro("input-placeholder-foreground","--vscode-input-placeholderForeground").withDefault("#cccccc"),ro("link-active-foreground","--vscode-textLink-activeForeground").withDefault("#3794ff"),ro("link-foreground","--vscode-textLink-foreground").withDefault("#3794ff"),ro("progress-background","--vscode-progressBar-background").withDefault("#0e70c0"),ro("panel-tab-active-border","--vscode-panelTitle-activeBorder").withDefault("#e7e7e7"),ro("panel-tab-active-foreground","--vscode-panelTitle-activeForeground").withDefault("#e7e7e7"),ro("panel-tab-foreground","--vscode-panelTitle-inactiveForeground").withDefault("#e7e7e799"),ro("panel-view-background","--vscode-panel-background").withDefault("#1e1e1e"),ro("panel-view-border","--vscode-panel-border").withDefault("#80808059"),ro("tag-corner-radius").withDefault("2px"),Jt`
	${Oo="inline-flex",`:host([hidden]){display:none}:host{display:${Oo}}`} :host {
		outline: none;
		font-family: ${ho};
		font-size: ${fo};
		line-height: ${bo};
	...
	.control:${eo} {
		outline: calc(${so} * 1px) solid ${lo};
		outline-offset: calc(${so} * 2px);
	}
...
`);var Oo;const Ro=Jt`
	...
	:host([appearance='primary']) .control:${eo} {
		outline: calc(${so} * 1px) solid ${lo};
		outline-offset: calc(${so} * 2px);
	}
...
`,Lo=Jt`
	...
	:host([appearance='secondary']) .control:${eo} {
		outline: calc(${so} * 1px) solid ${lo};
		outline-offset: calc(${so} * 2px);
	}
...
`,Eo=Jt`
	...
	:host([appearance='icon']) .control:${eo} {
		outline: calc(${so} * 1px) solid ${lo};
		outline-offset: ${vo};
	}
...
`;class Bo extends Gt{connectedCallback(){if(super.connectedCallback(),!this.appearance){const e=this.getAttribute("appearance");this.appearance=e}}attributeChangedCallback(e,t,o){if("appearance"===e&&"icon"===o){this.getAttribute("aria-label")||(this.ariaLabel="Icon Button")}"aria-label"===e&&(this.ariaLabel=o),"disabled"===e&&(this.disabled=null!==o)}}_([R],Bo.prototype,"appearance",void 0);const Fo=Bo.compose({baseName:"button",template:(e,t)=>Et`
    <button
        class="control"
        part="control"
...
`,styles:(e,t)=>Jt`
	...
	${Lo}
	${Eo}
`,shadowOptions:{delegatesFocus:!0}});var _o=(e=>(e[e.VerificationRequired=-1]="VerificationRequired",e[e.Free=0]="Free",e[e.FreeInPreviewTrial=1]="FreeInPreviewTrial",e[e.FreePreviewTrialExpired=2]="FreePreviewTrialExpired",e[e.FreePlusInTrial=3]="FreePlusInTrial",e[e.FreePlusTrialExpired=4]="FreePlusTrialExpired",e[e.Paid=5]="Paid",e))(_o||{});function Mo(e,t){return Io(e.plan.effective.expiresOn,t)}function Io(e,t){return null!=e?function(e,t,o){const n=("number"==typeof t?t:t.getTime())-("number"==typeof e?e:e.getTime());switch(o){case"days":return Math.floor(n/864e5);case"hours":return Math.floor(n/36e5);case"minutes":return Math.floor(n/6e4);case"seconds":return Math.floor(n/1e3);default:return n}}(Date.now(),new Date(e),t):void 0}class Vo{constructor(e,t=!1){this.method=e,this.reset=t}}class No extends Vo{}class zo extends Vo{}function jo(e,t,o){e.method===t.method&&o(t.params,e)}const qo=new No("webview/ready"),Uo=new No("webview/focus"),Ho=new No("command/execute");new No("configuration/preview"),new No("configuration/update"),new zo("configuration/didChange"),new zo("configuration/didPreview"),new zo("webview/didOpenAnchor");const Go=new No("home/step/complete"),Wo=new No("home/section/dismiss"),Qo=new No("home/status/dismiss"),Yo=new No("home/banner/dismiss"),Ko=new zo("subscription/didChange"),Zo=new zo("extensionEnabled/didChange"),Jo=new zo("configuration/didChange"),Xo=new zo("layout/didChange");function en(e,t){let o,n,r,s,i;function a(e){const o=e-(n??0);return null==n||o>=t||o<0}function c(){const e=Date.now();if(a(e))l();else{i=setTimeout(c,t-(e-(n??0)))}}function l(){return i=void 0,o?function(){const t=o,n=r;return o=r=void 0,s=e.apply(n,t),s}():(o=r=void 0,s)}function h(...e){const l=Date.now(),h=a(l);return o=e,r=this,n=l,h&&null==i?(i=setTimeout(c,t),s):(null==i&&(i=setTimeout(c,t)),s)}return h.cancel=function(){null!=i&&clearTimeout(i),o=n=r=i=void 0},h.flush=function(){return null!=i?l():s},h.pending=function(){return null!=i},h}var tn=(e=>(e.Off="off",e.Error="error",e.Warn="warn",e.Info="info",e.Debug="debug",e))(tn||{});const on="";const nn=new class{constructor(){this._isDebugging=!1,this.level=0,this._logLevel=tn.Off}configure(e,t,o=!1){this.provider=e,this._isDebugging=o,this.logLevel=t}enabled(e){return this.level>=rn(e)}get isDebugging(){return this._isDebugging}get logLevel(){return this._logLevel}set logLevel(e){this._logLevel=e,this.level=rn(this._logLevel),e===tn.Off?(this.output?.dispose?.(),this.output=void 0):this.output=this.output??this.provider.createChannel(this.provider.name)}get timestamp(){return`[${(new Date).toISOString().replace(/T/," ").slice(0,-1)}]`}debug(e,...t){if(this.level<4&&!this.isDebugging)return;let o;"string"==typeof e?o=e:(o=t.shift(),null!=e&&(o=`${e.prefix} ${o??on}`)),this.isDebugging,null==this.output||this.level<4||this.output.appendLine(`${this.timestamp} ${o??on}${this.toLoggableParams(!0,t)}`)}error(e,t,...o){if(this.level<1&&!this.isDebugging)return;let n;if(n=null==t||"string"==typeof t?t:`${t.prefix} ${o.shift()??on}`,null==n){const t=e instanceof Error?e.stack:void 0;if(t){const e=/.*\s*?at\s(.+?)\s/.exec(t);null!=e&&(n=e[1])}}this.isDebugging,null==this.output||this.level<1||this.output.appendLine(`${this.timestamp} ${n??on}${this.toLoggableParams(!1,o)}\n${String(e)}`)}log(e,...t){if(this.level<3&&!this.isDebugging)return;let o;"string"==typeof e?o=e:(o=t.shift(),null!=e&&(o=`${e.prefix} ${o??on}`)),this.isDebugging,null==this.output||this.level<3||this.output.appendLine(`${this.timestamp} ${o??on}${this.toLoggableParams(!1,t)}`)}warn(e,...t){if(this.level<2&&!this.isDebugging)return;let o;"string"==typeof e?o=e:(o=t.shift(),null!=e&&(o=`${e.prefix} ${o??on}`)),this.isDebugging,null==this.output||this.level<2||this.output.appendLine(`${this.timestamp} ${o??on}${this.toLoggableParams(!1,t)}`)}showOutputChannel(e){this.output?.show?.(e)}toLoggable(e,t){if("object"!=typeof e)return String(e);const o=this.provider.toLoggable?.(e);if(null!=o)return o;try{return JSON.stringify(e,t)}catch{return"<error>"}}toLoggableParams(e,t){if(0===t.length||e&&this.level<4&&!this.isDebugging)return on;const o=t.map((e=>this.toLoggable(e))).join(", ");return 0!==o.length?` — ${o}`:on}};function rn(e){switch(e){case tn.Off:return 0;case tn.Error:return 1;case tn.Warn:return 2;case tn.Info:return 3;case tn.Debug:return 4;default:return 0}}var sn,an;(an=sn||(sn={})).on=function(e,t,o,n){let r=!1;if("string"==typeof e){const s=function(t){const n=t?.target?.closest(e);null!=n&&o(t,n)};return document.addEventListener(t,s,n??!0),{dispose:()=>{r||(r=!0,document.removeEventListener(t,s,n??!0))}}}const s=function(e){o(e,this)};return e.addEventListener(t,s,n??!1),{dispose:()=>{r||(r=!0,e.removeEventListener(t,s,n??!1))}}},an.insertTemplate=function(e,t,o){const n=document.getElementById(e);if(t.replaceChildren(n?.content.cloneNode(!0)),t.className=n.className,null!=o?.visible){const e=t.querySelectorAll("[data-visible]");for(const t of e){const e=t.dataset.visible;e&&(o.visible[e]?t.style.display="initial":t.style.display="none")}}if(null!=o?.bindings){const e=t.querySelectorAll("[data-bind]");for(const t of e){const e=t.dataset.bind;if(!e)continue;const n=o.bindings[e];null!=n&&(t.textContent=String(n))}}},an.resetSlot=function(e){e.replaceChildren(),e.className=""};var cn=(e=>(e[e.Hash=35]="Hash",e[e.Slash=47]="Slash",e[e.Digit0=48]="Digit0",e[e.Digit1=49]="Digit1",e[e.Digit2=50]="Digit2",e[e.Digit3=51]="Digit3",e[e.Digit4=52]="Digit4",e[e.Digit5=53]="Digit5",e[e.Digit6=54]="Digit6",e[e.Digit7=55]="Digit7",e[e.Digit8=56]="Digit8",e[e.Digit9=57]="Digit9",e[e.Backslash=92]="Backslash",e[e.A=65]="A",e[e.B=66]="B",e[e.C=67]="C",e[e.D=68]="D",e[e.E=69]="E",e[e.F=70]="F",e[e.Z=90]="Z",e[e.a=97]="a",e[e.b=98]="b",e[e.c=99]="c",e[e.d=100]="d",e[e.e=101]="e",e[e.f=102]="f",e[e.z=122]="z",e))(cn||{});function ln(e,t){const o=e+t,n=t<0?o<0?0:o:o>255?255:o;return Math.round(n)}function hn(e,t){return dn(e,-t)}function dn(e,t){const o=function(e){const t=Cn(e);return null==t?null:[t.rgba.r,t.rgba.g,t.rgba.b,t.rgba.a]}(e);if(null==o)return e;const[n,r,s,i]=o,a=255*t/100;return`rgba(${ln(n,a)}, ${ln(r,a)}, ${ln(s,a)}, ${i})`}function un(e,t){const o=vn.from(e);return null==o?e:o.transparent(t/100).toString()}function fn(e,t){const o=Math.pow(10,t);return Math.round(e*o)/o}class bn{constructor(e,t,o,n=1){this._rgbaBrand=void 0,this.r=0|Math.min(255,Math.max(0,e)),this.g=0|Math.min(255,Math.max(0,t)),this.b=0|Math.min(255,Math.max(0,o)),this.a=fn(Math.max(Math.min(1,n),0),3)}static equals(e,t){return e.r===t.r&&e.g===t.g&&e.b===t.b&&e.a===t.a}}class pn{constructor(e,t,o,n){this._hslaBrand=void 0,this.h=0|Math.max(Math.min(360,e),0),this.s=fn(Math.max(Math.min(1,t),0),3),this.l=fn(Math.max(Math.min(1,o),0),3),this.a=fn(Math.max(Math.min(1,n),0),3)}static equals(e,t){return e.h===t.h&&e.s===t.s&&e.l===t.l&&e.a===t.a}static fromRGBA(e){const t=e.r/255,o=e.g/255,n=e.b/255,r=e.a,s=Math.max(t,o,n),i=Math.min(t,o,n);let a=0,c=0;const l=(i+s)/2,h=s-i;if(h>0){switch(c=Math.min(l<=.5?h/(2*l):h/(2-2*l),1),s){case t:a=(o-n)/h+(o<n?6:0);break;case o:a=(n-t)/h+2;break;case n:a=(t-o)/h+4}a*=60,a=Math.round(a)}return new pn(a,c,l,r)}static _hue2rgb(e,t,o){return o<0&&(o+=1),o>1&&(o-=1),o<1/6?e+6*(t-e)*o:o<.5?t:o<2/3?e+(t-e)*(2/3-o)*6:e}static toRGBA(e){const t=e.h/360,{s:o,l:n,a:r}=e;let s,i,a;if(0===o)s=i=a=n;else{const e=n<.5?n*(1+o):n+o-n*o,r=2*n-e;s=pn._hue2rgb(r,e,t+1/3),i=pn._hue2rgb(r,e,t),a=pn._hue2rgb(r,e,t-1/3)}return new bn(Math.round(255*s),Math.round(255*i),Math.round(255*a),r)}}class gn{constructor(e,t,o,n){this._hsvaBrand=void 0,this.h=0|Math.max(Math.min(360,e),0),this.s=fn(Math.max(Math.min(1,t),0),3),this.v=fn(Math.max(Math.min(1,o),0),3),this.a=fn(Math.max(Math.min(1,n),0),3)}static equals(e,t){return e.h===t.h&&e.s===t.s&&e.v===t.v&&e.a===t.a}static fromRGBA(e){const t=e.r/255,o=e.g/255,n=e.b/255,r=Math.max(t,o,n),s=r-Math.min(t,o,n),i=0===r?0:s/r;let a;return a=0===s?0:r===t?((o-n)/s%6+6)%6:r===o?(n-t)/s+2:(t-o)/s+4,new gn(Math.round(60*a),i,r,e.a)}static toRGBA(e){const{h:t,s:o,v:n,a:r}=e,s=n*o,i=s*(1-Math.abs(t/60%2-1)),a=n-s;let[c,l,h]=[0,0,0];return t<60?(c=s,l=i):t<120?(c=i,l=s):t<180?(l=s,h=i):t<240?(l=i,h=s):t<300?(c=i,h=s):t<=360&&(c=s,h=i),c=Math.round(255*(c+a)),l=Math.round(255*(l+a)),h=Math.round(255*(h+a)),new bn(c,l,h,r)}}const mn=class{static from(e){return e instanceof mn?e:Cn(e)||mn.red}static fromCssVariable(e,t){return Cn(t.getPropertyValue(e).trim())||mn.red}static fromHex(e){return $n(e)||mn.red}static equals(e,t){return!e&&!t||!(!e||!t)&&e.equals(t)}get hsla(){return this._hsla?this._hsla:pn.fromRGBA(this.rgba)}get hsva(){return this._hsva?this._hsva:gn.fromRGBA(this.rgba)}constructor(e){if(!e)throw new Error("Color needs a value");if(e instanceof bn)this.rgba=e;else if(e instanceof pn)this._hsla=e,this.rgba=pn.toRGBA(e);else{if(!(e instanceof gn))throw new Error("Invalid color ctor argument");this._hsva=e,this.rgba=gn.toRGBA(e)}}equals(e){return null!=e&&(Boolean(e)&&bn.equals(this.rgba,e.rgba)&&pn.equals(this.hsla,e.hsla)&&gn.equals(this.hsva,e.hsva))}getRelativeLuminance(){return fn(.2126*mn._relativeLuminanceForComponent(this.rgba.r)+.7152*mn._relativeLuminanceForComponent(this.rgba.g)+.0722*mn._relativeLuminanceForComponent(this.rgba.b),4)}static _relativeLuminanceForComponent(e){const t=e/255;return t<=.03928?t/12.92:Math.pow((t+.055)/1.055,2.4)}luminance(e){return function(e,t){if(0===t)return new vn(new bn(0,0,0,e.rgba.a));if(1===t)return new vn(new bn(255,255,255,e.rgba.a));const o=e.getRelativeLuminance();let n=20;const r=(e,o)=>{const s=e.mix(o,.5),i=s.getRelativeLuminance();return Math.abs(t-i)<1e-7||!n--?s:i>t?r(e,s):r(s,o)},s=(o>t?r(vn.black,e):r(e,vn.white)).rgba;return new vn(new bn(s.r,s.g,s.b,e.rgba.a))}(this,e)}getContrastRatio(e){const t=this.getRelativeLuminance(),o=e.getRelativeLuminance();return t>o?(t+.05)/(o+.05):(o+.05)/(t+.05)}isDarker(){return(299*this.rgba.r+587*this.rgba.g+114*this.rgba.b)/1e3<128}isLighter(){return(299*this.rgba.r+587*this.rgba.g+114*this.rgba.b)/1e3>=128}isLighterThan(e){return this.getRelativeLuminance()>e.getRelativeLuminance()}isDarkerThan(e){return this.getRelativeLuminance()<e.getRelativeLuminance()}lighten(e){return new mn(new pn(this.hsla.h,this.hsla.s,this.hsla.l+this.hsla.l*e,this.hsla.a))}darken(e){return new mn(new pn(this.hsla.h,this.hsla.s,this.hsla.l-this.hsla.l*e,this.hsla.a))}transparent(e){const{r:t,g:o,b:n,a:r}=this.rgba;return new mn(new bn(t,o,n,r*e))}isTransparent(){return 0===this.rgba.a}isOpaque(){return 1===this.rgba.a}opposite(){return new mn(new bn(255-this.rgba.r,255-this.rgba.g,255-this.rgba.b,this.rgba.a))}blend(e){const t=e.rgba,o=this.rgba.a,n=t.a,r=o+n*(1-o);if(r<1e-6)return mn.transparent;const s=this.rgba.r*o/r+t.r*n*(1-o)/r,i=this.rgba.g*o/r+t.g*n*(1-o)/r,a=this.rgba.b*o/r+t.b*n*(1-o)/r;return new mn(new bn(s,i,a,r))}mix(e,t){return function(e,t,o){const n=e.rgba,r=t.rgba;return new vn(new bn(n.r+o*(r.r-n.r),n.g+o*(r.g-n.g),n.b+o*(r.b-n.b),n.a+o*(r.a-n.a)))}(this,e,t)}makeOpaque(e){if(this.isOpaque()||1!==e.rgba.a)return this;const{r:t,g:o,b:n,a:r}=this.rgba;return new mn(new bn(e.rgba.r-r*(e.rgba.r-t),e.rgba.g-r*(e.rgba.g-o),e.rgba.b-r*(e.rgba.b-n),1))}flatten(...e){const t=e.reduceRight(((e,t)=>mn._flatten(t,e)));return mn._flatten(this,t)}static _flatten(e,t){const o=1-e.rgba.a;return new mn(new bn(o*t.rgba.r+e.rgba.a*e.rgba.r,o*t.rgba.g+e.rgba.a*e.rgba.g,o*t.rgba.b+e.rgba.a*e.rgba.b))}toString(){return this._toString||(this._toString=function(e){if(e.isOpaque())return kn(e);return yn(e)}(this)),this._toString}static getLighterColor(e,t,o){if(e.isLighterThan(t))return e;o=o||.5;const n=e.getRelativeLuminance(),r=t.getRelativeLuminance();return o=o*(r-n)/r,e.lighten(o)}static getDarkerColor(e,t,o){if(e.isDarkerThan(t))return e;o=o||.5;const n=e.getRelativeLuminance();return o=o*(n-t.getRelativeLuminance())/n,e.darken(o)}};let vn=mn;function yn(e){return`rgba(${e.rgba.r}, ${e.rgba.g}, ${e.rgba.b}, ${Number(e.rgba.a.toFixed(2))})`}function wn(e){const t=e.toString(16);return 2!==t.length?`0${t}`:t}function kn(e){return`#${wn(e.rgba.r)}${wn(e.rgba.g)}${wn(e.rgba.b)}`}vn.white=new mn(new bn(255,255,255,1)),vn.black=new mn(new bn(0,0,0,1)),vn.red=new mn(new bn(255,0,0,1)),vn.blue=new mn(new bn(0,0,255,1)),vn.green=new mn(new bn(0,255,0,1)),vn.cyan=new mn(new bn(0,255,255,1)),vn.lightgrey=new mn(new bn(211,211,211,1)),vn.transparent=new mn(new bn(0,0,0,0));const xn=/^((?:rgb|hsl)a?)\((-?\d+%?)[,\s]+(-?\d+%?)[,\s]+(-?\d+%?)[,\s]*(-?[\d.]+%?)?\)$/i;function Cn(e){if(0===e.length)return null;if(e.charCodeAt(0)===cn.Hash)return $n(e);const t=xn.exec(e);if(null==t)return null;const o=t[1];let n;switch(o){case"rgb":case"hsl":n=[parseInt(t[2],10),parseInt(t[3],10),parseInt(t[4],10),1];break;case"rgba":case"hsla":n=[parseInt(t[2],10),parseInt(t[3],10),parseInt(t[4],10),parseFloat(t[5])];break;default:return null}switch(o){case"rgb":case"rgba":return new vn(new bn(n[0],n[1],n[2],n[3]));case"hsl":case"hsla":return new vn(new pn(n[0],n[1],n[2],n[3]))}return vn.red}function $n(e){const t=(e=e.trim()).length;if(0===t)return null;if(e.charCodeAt(0)!==cn.Hash)return null;if(7===t){const t=16*Pn(e.charCodeAt(1))+Pn(e.charCodeAt(2)),o=16*Pn(e.charCodeAt(3))+Pn(e.charCodeAt(4)),n=16*Pn(e.charCodeAt(5))+Pn(e.charCodeAt(6));return new vn(new bn(t,o,n,1))}if(9===t){const t=16*Pn(e.charCodeAt(1))+Pn(e.charCodeAt(2)),o=16*Pn(e.charCodeAt(3))+Pn(e.charCodeAt(4)),n=16*Pn(e.charCodeAt(5))+Pn(e.charCodeAt(6)),r=16*Pn(e.charCodeAt(7))+Pn(e.charCodeAt(8));return new vn(new bn(t,o,n,r/255))}if(4===t){const t=Pn(e.charCodeAt(1)),o=Pn(e.charCodeAt(2)),n=Pn(e.charCodeAt(3));return new vn(new bn(16*t+t,16*o+o,16*n+n))}if(5===t){const t=Pn(e.charCodeAt(1)),o=Pn(e.charCodeAt(2)),n=Pn(e.charCodeAt(3)),r=Pn(e.charCodeAt(4));return new vn(new bn(16*t+t,16*o+o,16*n+n,(16*r+r)/255))}return null}function Pn(e){switch(e){case cn.Digit0:return 0;case cn.Digit1:return 1;case cn.Digit2:return 2;case cn.Digit3:return 3;case cn.Digit4:return 4;case cn.Digit5:return 5;case cn.Digit6:return 6;case cn.Digit7:return 7;case cn.Digit8:return 8;case cn.Digit9:return 9;case cn.a:case cn.A:return 10;case cn.b:case cn.B:return 11;case cn.c:case cn.C:return 12;case cn.d:case cn.D:return 13;case cn.e:case cn.E:return 14;case cn.f:case cn.F:return 15}return 0}const Sn=class{constructor(){this._disposed=!1}get event(){return null==this._event&&(this._event=(e,t,o)=>{null==this.listeners&&(this.listeners=new Rn);const n=this.listeners.push(null==t?e:[e,t]),r={dispose:()=>{r.dispose=Sn._noop,this._disposed||n()}};return Array.isArray(o)&&o.push(r),r}),this._event}fire(e){if(null!=this.listeners){null==this._deliveryQueue&&(this._deliveryQueue=new Rn);for(let t=this.listeners.iterator(),o=t.next();!o.done;o=t.next())this._deliveryQueue.push([o.value,e]);for(;this._deliveryQueue.size>0;){const[e,t]=this._deliveryQueue.shift();try{"function"==typeof e?e(t):e[0].call(e[1],t)}catch(e){}}}}dispose(){this.listeners?.clear(),this._deliveryQueue?.clear(),this._disposed=!0}};let Dn=Sn;Dn._noop=function(){};const Tn={done:!0,value:void 0},An=class{constructor(e){this.element=e,this.next=An.Undefined,this.prev=An.Undefined}};let On=An;On.Undefined=new An(void 0);class Rn{constructor(){this._first=On.Undefined,this._last=On.Undefined,this._size=0}get size(){return this._size}isEmpty(){return this._first===On.Undefined}clear(){this._first=On.Undefined,this._last=On.Undefined,this._size=0}unshift(e){return this._insert(e,!1)}push(e){return this._insert(e,!0)}_insert(e,t){const o=new On(e);if(this._first===On.Undefined)this._first=o,this._last=o;else if(t){const e=this._last;this._last=o,o.prev=e,e.next=o}else{const e=this._first;this._first=o,o.next=e,e.prev=o}this._size+=1;let n=!1;return()=>{n||(n=!0,this._remove(o))}}shift(){if(this._first===On.Undefined)return;const e=this._first.element;return this._remove(this._first),e}pop(){if(this._last===On.Undefined)return;const e=this._last.element;return this._remove(this._last),e}_remove(e){if(e.prev!==On.Undefined&&e.next!==On.Undefined){const t=e.prev;t.next=e.next,e.next.prev=t}else e.prev===On.Undefined&&e.next===On.Undefined?(this._first=On.Undefined,this._last=On.Undefined):e.next===On.Undefined?(this._last=this._last.prev,this._last.next=On.Undefined):e.prev===On.Undefined&&(this._first=this._first.next,this._first.prev=On.Undefined);this._size-=1}iterator(){let e,t=this._first;return{next:function(){return t===On.Undefined?Tn:(null==e?e={done:!1,value:t.element}:e.value=t.element,t=t.next,e)}}}toArray(){const e=[];for(let t=this._first;t!==On.Undefined;t=t.next)e.push(t.element);return e}}const Ln=new Dn,En=Ln.event;let Bn=0;function Fn(){return 1073741824===Bn?Bn=1:Bn++,`webview:${Bn}`}class _n{constructor(e){this.appName=e,this.state=window.bootstrap,window.bootstrap=void 0,nn.configure({name:e,createChannel:function(e){return{name:e,appendLine:function(e){}}}},tn.Off),this.log("ctor()"),this._api=acquireVsCodeApi();const t=[];null!=this.onThemeUpdated&&t.push(En(this.onThemeUpdated,this)),t.push(function(){const e=e=>{const t=document.body,o=window.getComputedStyle(t),n=t.classList.contains("vscode-light")||t.classList.contains("vscode-high-contrast-light"),r=t.classList.contains("vscode-high-contrast")||t.classList.contains("vscode-high-contrast-light"),s=t.style;s.setProperty("--font-family",o.getPropertyValue("--vscode-font-family").trim()),s.setProperty("--font-size",o.getPropertyValue("--vscode-font-size").trim()),s.setProperty("--font-weight",o.getPropertyValue("--vscode-font-weight").trim()),s.setProperty("--editor-font-family",o.getPropertyValue("--vscode-editor-font-family").trim()),s.setProperty("--editor-font-size",o.getPropertyValue("--vscode-editor-font-size").trim()),s.setProperty("--editor-font-weight",o.getPropertyValue("--vscode-editor-font-weight").trim());const i=o.getPropertyValue("--vscode-editor-background").trim();let a=o.getPropertyValue("--vscode-editor-foreground").trim();a||(a=o.getPropertyValue("--vscode-foreground").trim());let c=i;s.setProperty("--color-background",c),s.setProperty("--color-background--lighten-05",dn(c,5)),s.setProperty("--color-background--darken-05",hn(c,5)),s.setProperty("--color-background--lighten-075",dn(c,7.5)),s.setProperty("--color-background--darken-075",hn(c,7.5)),s.setProperty("--color-background--lighten-10",dn(c,10)),s.setProperty("--color-background--darken-10",hn(c,10)),s.setProperty("--color-background--lighten-15",dn(c,15)),s.setProperty("--color-background--darken-15",hn(c,15)),s.setProperty("--color-background--lighten-30",dn(c,30)),s.setProperty("--color-background--darken-30",hn(c,30)),s.setProperty("--color-background--lighten-50",dn(c,50)),s.setProperty("--color-background--darken-50",hn(c,50)),c=o.getPropertyValue("--vscode-button-background").trim(),s.setProperty("--color-button-background",c),s.setProperty("--color-button-background--darken-30",hn(c,30)),s.setProperty("--color-highlight",c),s.setProperty("--color-highlight--75",un(c,75)),s.setProperty("--color-highlight--50",un(c,50)),s.setProperty("--color-highlight--25",un(c,25)),c=o.getPropertyValue("--vscode-button-secondaryBackground").trim(),s.setProperty("--color-button-secondary-background",c),s.setProperty("--color-button-secondary-background--darken-30",hn(c,30)),c=o.getPropertyValue("--vscode-button-foreground").trim(),s.setProperty("--color-button-foreground",c),s.setProperty("--color-foreground",a),s.setProperty("--color-foreground--85",un(a,85)),s.setProperty("--color-foreground--75",un(a,75)),s.setProperty("--color-foreground--65",un(a,65)),s.setProperty("--color-foreground--50",un(a,50)),c=o.getPropertyValue("--vscode-focusBorder").trim(),s.setProperty("--color-focus-border",c),c=o.getPropertyValue("--vscode-textLink-foreground").trim(),s.setProperty("--color-link-foreground",c),s.setProperty("--color-link-foreground--darken-20",hn(c,20)),s.setProperty("--color-link-foreground--lighten-20",dn(c,20)),c=o.getPropertyValue("--vscode-sideBar-background").trim(),s.setProperty("--color-view-background",c||i),c=o.getPropertyValue("--vscode-sideBar-foreground").trim(),s.setProperty("--color-view-foreground",c||a),s.setProperty("--color-view-header-foreground",o.getPropertyValue("--vscode-sideBarSectionHeader-foreground").trim()||c||a),c=o.getPropertyValue("--vscode-editorHoverWidget-background").trim(),s.setProperty("--color-hover-background",c),c=o.getPropertyValue("--vscode-editorHoverWidget-border").trim(),s.setProperty("--color-hover-border",c),c=o.getPropertyValue("--vscode-editorHoverWidget-foreground").trim(),s.setProperty("--color-hover-foreground",c),c=o.getPropertyValue("--vscode-editorHoverWidget-statusBarBackground").trim(),s.setProperty("--color-hover-statusBarBackground",c),c=o.getPropertyValue("--vscode-inputValidation-infoBackground").trim(),s.setProperty("--color-alert-infoHoverBackground",n?hn(c,5):dn(c,5)),s.setProperty("--color-alert-infoBackground",c),c=o.getPropertyValue("--vscode-inputValidation-warningBackground").trim(),s.setProperty("--color-alert-warningHoverBackground",n?hn(c,5):dn(c,5)),s.setProperty("--color-alert-warningBackground",c),c=o.getPropertyValue("--vscode-inputValidation-errorBackground").trim(),s.setProperty("--color-alert-errorHoverBackground",n?hn(c,5):dn(c,5)),s.setProperty("--color-alert-errorBackground",c),c=n?hn(i,5):dn(i,5),s.setProperty("--color-alert-neutralHoverBackground",n?hn(c,5):dn(c,5)),s.setProperty("--color-alert-neutralBackground",c),s.setProperty("--color-alert-infoBorder","var(--vscode-inputValidation-infoBorder)"),s.setProperty("--color-alert-warningBorder","var(--vscode-inputValidation-warningBorder)"),s.setProperty("--color-alert-errorBorder","var(--vscode-inputValidation-errorBorder)"),s.setProperty("--color-alert-neutralBorder","var(--vscode-input-foreground)"),s.setProperty("--color-alert-foreground","var(--vscode-input-foreground)"),Ln.fire({colors:{background:i,foreground:a},computedStyle:o,isLightTheme:n,isHighContrastTheme:r,isInitializing:null==e})};e();const t=new MutationObserver(e);return t.observe(document.body,{attributeFilter:["class"]}),{dispose:()=>t.disconnect()}}()),requestAnimationFrame((()=>{this.log("ctor(): initializing...");try{this.onInitialize?.(),this.bind(),null!=this.onMessageReceived&&t.push(sn.on(window,"message",this.onMessageReceived.bind(this))),this.sendCommand(qo,void 0),this.onInitialized?.()}finally{document.body.classList.contains("preload")&&setTimeout((()=>{document.body.classList.remove("preload")}),500)}})),t.push(sn.on(window,"pagehide",(()=>{t?.forEach((e=>e.dispose())),this.bindDisposables?.forEach((e=>e.dispose())),this.bindDisposables=void 0})))}bind(){this.bindDisposables?.forEach((e=>e.dispose())),this.bindDisposables=this.onBind?.(),null==this.bindDisposables&&(this.bindDisposables=[]);const e=en((e=>{this.sendCommand(Uo,e)}),150);this.bindDisposables.push(sn.on(document,"focusin",(t=>{const o=t.composedPath().some((e=>"INPUT"===e.tagName));!0===this._focused&&this._inputFocused===o||(this._focused=!0,this._inputFocused=o,e({focused:!0,inputFocused:o}))})),sn.on(document,"focusout",(()=>{!1===this._focused&&!1===this._inputFocused||(this._focused=!1,this._inputFocused=!1,e({focused:!1,inputFocused:!1}))})))}log(e,...t){nn.log(e,...t)}getState(){return this._api.getState()}sendCommand(e,t){const o=Fn();this.log(`sendCommand(${o}): name=${e.method}`),this.postMessage({id:o,method:e.method,params:t})}async sendCommandWithCompletion(e,t,o){const n=Fn();this.log(`sendCommandWithCompletion(${n}): name=${e.method}`);const r=new Promise(((e,t)=>{let r;const s=[sn.on(window,"message",(t=>{jo(o,t.data,(o=>{t.data.completionId===n&&(s.forEach((e=>e.dispose())),queueMicrotask((()=>e(o))))}))})),{dispose:function(){null!=r&&(clearTimeout(r),r=void 0)}}];r=setTimeout((()=>{r=void 0,s.forEach((e=>e.dispose())),t(new Error(`Timed out waiting for completion of ${o.method}`))}),6e4)}));return this.postMessage({id:n,method:e.method,params:t,completionId:n}),r}setState(e){this.state=e,null!=e&&this._api.setState(e)}postMessage(e){this._api.postMessage(e)}}var Mn=Object.defineProperty,In=Object.getOwnPropertyDescriptor,Vn=(e,t,o,n)=>{for(var r,s=n>1?void 0:n?In(t,o):t,i=e.length-1;i>=0;i--)(r=e[i])&&(s=(n?r(t,o,s):r(s))||s);return n&&s&&Mn(t,o,s),s};const Nn=Jt`
	:host {
...
`;let zn=class extends j{constructor(){super(...arguments),this.icon="",this.modifier="",this.size=16}sizeChanged(){this.style.setProperty("--code-icon-size",`${this.size}px`)}};function jn(e,t){const o="function"==typeof t?t:()=>t;return(t,n)=>e(t,n)?o(t,n):null}function qn(...e){return e.some((e=>(e?.length??0)>0))}Vn([R],zn.prototype,"icon",2),Vn([R],zn.prototype,"modifier",2),Vn([R],zn.prototype,"size",2),zn=Vn([q({name:"code-icon",styles:Nn})],zn);const Un=Jt`
	:host {
		box-sizing: border-box;
	}
	:host *,
...
`;var Hn=Object.defineProperty,Gn=Object.getOwnPropertyDescriptor,Wn=(e,t,o,n)=>{for(var r,s=n>1?void 0:n?Gn(t,o):t,i=e.length-1;i>=0;i--)(r=e[i])&&(s=(n?r(t,o,s):r(s))||s);return n&&s&&Hn(t,o,s),s};const Qn=Et`
	<template>
		...
		${jn((e=>e.caret),Et`<span class="caret"></span>`)}
	</template>
`,Yn=Jt`
	${Un}
...
`;let Kn=class extends j{constructor(){super(...arguments),this.open=!1,this.caret=!0}get hasTopNodes(){return qn(this.typeNodes,this.actionsNodes)}get hasHeadingNodes(){return qn(this.headingNodes)}};Wn([R({mode:"boolean"})],Kn.prototype,"open",2),Wn([R({mode:"boolean"})],Kn.prototype,"caret",2),Wn([R],Kn.prototype,"placement",2),Wn([m],Kn.prototype,"typeNodes",2),Wn([m],Kn.prototype,"actionsNodes",2),Wn([m],Kn.prototype,"headingNodes",2),Wn([v],Kn.prototype,"hasTopNodes",1),Wn([v],Kn.prototype,"hasHeadingNodes",1),Kn=Wn([q({name:"pop-over",template:Qn,styles:Yn})],Kn);const Zn={toView:function(e){return e.toString()},fromView:function(e){return parseInt(e,10)}};var Jn=Object.defineProperty,Xn=Object.getOwnPropertyDescriptor,er=(e,t,o,n)=>{for(var r,s=n>1?void 0:n?Xn(t,o):t,i=e.length-1;i>=0;i--)(r=e[i])&&(s=(n?r(t,o,s):r(s))||s);return n&&s&&Jn(t,o,s),s};const tr=Et`<template role="region">
	${jn((e=>!1===e.noHeading),Et`<header>
			<div class="heading" role="heading" aria-level="${e=>e.headingLevel}">
				<slot name="heading"></slot>
				<small class="description"><slot name="description"></slot></small>
			</div>
			${jn((e=>e.dismissable),Et`<button
					class="dismiss"
					type="button"
...
`;let nr=class extends j{constructor(){super(...arguments),this.noHeading=!1,this.headingLevel=2,this.dismissable=!1,this.expanded=!0}handleDismiss(e){this.$emit("dismiss")}};er([R({attribute:"no-heading",mode:"boolean"})],nr.prototype,"noHeading",2),er([R({attribute:"heading-level",converter:Zn})],nr.prototype,"headingLevel",2),er([R({mode:"boolean"})],nr.prototype,"dismissable",2),er([R({mode:"boolean"})],nr.prototype,"expanded",2),nr=er([q({name:"card-section",template:tr,styles:or})],nr);const{fromCharCode:rr}=String;new TextEncoder;Object.getPrototypeOf((async function(){})).constructor;function sr(e,t,o){if(null==o)return`${t} ${e}${1===t?"":"s"}`;const n=1===t?e:o.plural??`${e}s`;return o.only?n:`${0===t?o.zero??t:o.format?.(t)??t}${o.infix??" "}${n}`}var ir=Object.defineProperty,ar=Object.getOwnPropertyDescriptor,cr=(e,t,o,n)=>{for(var r,s=n>1?void 0:n?ar(t,o):t,i=e.length-1;i>=0;i--)(r=e[i])&&(s=(n?r(t,o,s):r(s))||s);return n&&s&&ir(t,o,s),s};const lr=Et`
	...
	<h1 class="header-card__title${e=>""===e.name?" logo":""}">
		${jn((e=>""===e.name),Et`Git<span class="brand">Lens</span> 13`)}
		${jn((e=>""!==e.name),Et`${e=>e.name}`)}
	</h1>
	<p class="header-card__account">
		...
		<span class="account-actions">
			${jn((e=>!e.hasAccount),Et`<a class="action" href="command:gitlens.plus.loginOrSignUp">Sign In</a>`)}
			${jn((e=>e.hasAccount),Et`
					<a
						class="action is-icon"
	...
	<span class="actions">
		${jn((e=>e.state===_o.FreePreviewTrialExpired),Et`<a class="action is-primary" href="command:gitlens.plus.loginOrSignUp"
				>Extend Pro Trial</a
			>`)}
		${jn((e=>e.state===_o.FreeInPreviewTrial||e.state===_o.FreePlusInTrial||e.state===_o.FreePlusTrialExpired),Et`<a class="action is-primary" href="command:gitlens.plus.purchase">Upgrade to Pro</a>`)}
		${jn((e=>e.state===_o.VerificationRequired),Et`
				<a
...
`;let dr=class extends j{constructor(){super(...arguments),this.image="",this.name="",this.days=0,this.steps=4,this.completed=0,this.state=_o.Free,this.plan="",this.pinStatus=!0}attributeChangedCallback(e,t,o){super.attributeChangedCallback(e,t,o),t!==o&&null!=this.progressNode&&this.updateProgressWidth()}get daysRemaining(){return this.days<1?"<1 day":sr("day",this.days)}get progressNow(){return this.completed+1}get progressMax(){return this.steps+1}get progress(){return this.progressNow/this.progressMax*100+"%"}get planName(){switch(this.state){case _o.Free:case _o.FreePreviewTrialExpired:case _o.FreePlusTrialExpired:return"GitLens Free";case _o.FreeInPreviewTrial:case _o.FreePlusInTrial:return"GitLens Pro (Trial)";case _o.VerificationRequired:return`${this.plan} (Unverified)`;default:return this.plan}}get daysLeft(){switch(this.state){case _o.FreeInPreviewTrial:case _o.FreePlusInTrial:return`, ${this.daysRemaining} left`;default:return""}}get hasAccount(){switch(this.state){case _o.Free:case _o.FreePreviewTrialExpired:case _o.FreeInPreviewTrial:return!1}return!0}get isPro(){switch(this.state){case _o.Free:case _o.FreePreviewTrialExpired:case _o.FreePlusTrialExpired:case _o.VerificationRequired:return!1}return!0}updateProgressWidth(){this.progressNode.style.width=this.progress}dismissStatus(e){this.pinStatus=!1,this.$emit("dismiss-status"),window.requestAnimationFrame((()=>{this.statusNode?.focus()}))}};cr([R],dr.prototype,"image",2),cr([R],dr.prototype,"name",2),cr([R({converter:Zn})],dr.prototype,"days",2),cr([R({converter:Zn})],dr.prototype,"steps",2),cr([R({converter:Zn})],dr.prototype,"completed",2),cr([R({converter:Zn})],dr.prototype,"state",2),cr([R],dr.prototype,"plan",2),cr([R({attribute:"pin-status",mode:"boolean"})],dr.prototype,"pinStatus",2),cr([v],dr.prototype,"progress",1),cr([v],dr.prototype,"planName",1),cr([v],dr.prototype,"daysLeft",1),dr=cr([q({name:"header-card",template:lr,styles:hr})],dr);var ur=Object.defineProperty,fr=Object.getOwnPropertyDescriptor,br=(e,t,o,n)=>{for(var r,s=n>1?void 0:n?fr(t,o):t,i=e.length-1;i>=0;i--)(r=e[i])&&(s=(n?r(t,o,s):r(s))||s);return n&&s&&ur(t,o,s),s};const pr=Et`
	${jn((e=>e.state===_o.Free),Et`
			<h3>
	...
	${jn((e=>e.state===_o.Paid),Et`
		...
		`)}
	${jn((e=>e.state===_o.FreeInPreviewTrial),Et`
			...
			${jn((e=>e.extensionEnabled),Et`
				...
				`)}
		`)}
	${jn((e=>e.state===_o.FreePlusInTrial),Et`
			<h3>GitLens Pro Trial</h3>
			<p class="mb-1">
		...
		`)}
	${jn((e=>e.state===_o.FreePreviewTrialExpired),Et`
			...
			${jn((e=>e.extensionEnabled),Et`
				...
				`)}
		`)}
	${jn((e=>e.state===_o.FreePlusTrialExpired),Et`
	...
	${jn((e=>e.state===_o.VerificationRequired),Et`
		...
		`)}
	${jn((e=>[_o.Free,_o.FreePreviewTrialExpired,_o.FreePlusTrialExpired].includes(e.state)&&e.extensionEnabled),Et`
			<p class="mb-0">
				${jn((e=>e.plus),Et`<a class="minimal" href="command:gitlens.plus.hide">Hide GitLens+ features</a>`)}
				${jn((e=>!e.plus),Et`<a href="command:gitlens.plus.restore">Restore GitLens+ features</a>`)}
			</p>
		`)}
	${jn((e=>!e.extensionEnabled),Et`
			<p class="mb-0">
...
`;let mr=class extends j{constructor(){super(...arguments),this.days=0,this.state=_o.Free,this.plan="",this.visibility="public",this.plus=!0,this.extensionEnabled=!0}get daysRemaining(){return this.days<1?"less than one day":sr("day",this.days)}get isFree(){return["local","public"].includes(this.visibility)}get planName(){switch(this.state){case _o.Free:case _o.FreePreviewTrialExpired:case _o.FreePlusTrialExpired:return"GitLens Free";case _o.FreeInPreviewTrial:case _o.FreePlusInTrial:return"GitLens Pro (Trial)";case _o.VerificationRequired:return`${this.plan} (Unverified)`;default:return this.plan}}fireAction(e){this.$emit("action",e)}};br([R({converter:Zn})],mr.prototype,"days",2),br([R({converter:Zn})],mr.prototype,"state",2),br([R],mr.prototype,"plan",2),br([R],mr.prototype,"visibility",2),br([R({mode:"boolean"})],mr.prototype,"plus",2),br([m],mr.prototype,"extensionEnabled",2),br([v],mr.prototype,"planName",1),mr=br([q({name:"plus-banner",template:pr,styles:gr})],mr);var vr=Object.defineProperty,yr=Object.getOwnPropertyDescriptor,wr=(e,t,o,n)=>{for(var r,s=n>1?void 0:n?yr(t,o):t,i=e.length-1;i>=0;i--)(r=e[i])&&(s=(n?r(t,o,s):r(s))||s);return n&&s&&vr(t,o,s),s};const kr=Et`
	...
	<div class="content">
		${jn((e=>e.state===_o.Free),Et`
			...
			`)}
		${jn((e=>e.state!==_o.Free),Et` <p class="mb-0">All other GitLens features can always be used on any repo</p> `)}
	</div>
`,xr=Jt`
	* {
		box-sizing: border-box;
...
`;let Cr=class extends j{constructor(){super(...arguments),this.days=0,this.state=_o.Free,this.plan="",this.visibility="public"}get daysRemaining(){return this.days<1?"less than one day":sr("day",this.days)}get isFree(){return["local","public"].includes(this.visibility)}get planName(){switch(this.state){case _o.Free:case _o.FreePreviewTrialExpired:case _o.FreePlusTrialExpired:return"GitLens Free";case _o.FreeInPreviewTrial:case _o.FreePlusInTrial:return"GitLens Pro (Trial)";case _o.VerificationRequired:return`${this.plan} (Unverified)`;default:return this.plan}}fireAction(e){this.$emit("action",e)}};wr([R({converter:Zn})],Cr.prototype,"days",2),wr([R({converter:Zn})],Cr.prototype,"state",2),wr([R],Cr.prototype,"plan",2),wr([R],Cr.prototype,"visibility",2),wr([v],Cr.prototype,"planName",1),Cr=wr([q({name:"plus-content",template:kr,styles:xr})],Cr);var $r=Object.defineProperty,Pr=Object.getOwnPropertyDescriptor,Sr=(e,t,o,n)=>{for(var r,s=n>1?void 0:n?Pr(t,o):t,i=e.length-1;i>=0;i--)(r=e[i])&&(s=(n?r(t,o,s):r(s))||s);return n&&s&&$r(t,o,s),s};const Dr=Et`<template role="region">
...
`;let Ar=class extends j{constructor(){super(...arguments),this.headingLevel=2,this.completed=!1}handleClick(e){this.completed=!this.completed,this.$emit("complete",this.completed)}};Sr([R({attribute:"heading-level",converter:Zn})],Ar.prototype,"headingLevel",2),Sr([R({mode:"boolean"})],Ar.prototype,"completed",2),Ar=Sr([q({name:"stepped-section",template:Dr,styles:Tr})],Ar);class Or extends _n{constructor(){super("HomeApp")}onInitialize(){var e;nt.getOrCreate(e).withPrefix("vscode").register(Fo()),this.$steps=[...document.querySelectorAll("stepped-section[id]")],this.$cards=[...document.querySelectorAll("card-section[id]")],this.updateState()}onBind(){const e=super.onBind?.()??[];return e.push(sn.on("[data-action]","click",((e,t)=>this.onDataActionClicked(e,t)))),e.push(sn.on("plus-banner","action",((e,t)=>this.onPlusActionClicked(e,t)))),e.push(sn.on("stepped-section","complete",((e,t)=>this.onStepComplete(e,t)))),e.push(sn.on("card-section","dismiss",((e,t)=>this.onCardDismissed(e,t)))),e.push(sn.on("header-card","dismiss-status",((e,t)=>this.onStatusDismissed(e,t)))),e.push(sn.on("[data-banner-dismiss]","click",((e,t)=>this.onBannerDismissed(e,t)))),e}onMessageReceived(e){const t=e.data;switch(t.method){case Ko.method:this.log(`onMessageReceived(${t.id}): name=${t.method}`),jo(Ko,t,(e=>{this.state.subscription=e.subscription,this.state.completedActions=e.completedActions,this.state.avatar=e.avatar,this.state.pinStatus=e.pinStatus,this.updateState()}));break;case Zo.method:this.log(`onMessageReceived(${t.id}): name=${t.method}`),jo(Zo,t,(e=>{this.state.extensionEnabled=e.extensionEnabled,this.updateNoRepo()}));break;case Jo.method:this.log(`onMessageReceived(${t.id}): name=${t.method}`),jo(Jo,t,(e=>{this.state.plusEnabled=e.plusEnabled,this.updatePlusContent()}));break;case Xo.method:this.log(`onMessageReceived(${t.id}): name=${t.method}`),jo(Xo,t,(e=>{this.state.layout=e.layout,this.updateLayout()}));break;default:super.onMessageReceived?.(e)}}onStepComplete(e,t){const o=t.id,n=e.detail??!1;this.state.completedSteps=Rr(this.state.completedSteps,o,n),this.sendCommand(Go,{id:o,completed:n}),this.updateState()}onCardDismissed(e,t){const o=t.id;this.state.dismissedSections=Rr(this.state.dismissedSections,o),this.sendCommand(Wo,{id:o}),this.updateState()}onStatusDismissed(e,t){this.state.pinStatus=!1,this.sendCommand(Qo,void 0),this.updateHeader()}onBannerDismissed(e,t){const o=t.getAttribute("data-banner-dismiss");null==o||this.state.dismissedBanners?.includes(o)||(this.state.dismissedBanners=this.state.dismissedBanners??[],this.state.dismissedBanners.push(o),this.sendCommand(Yo,{id:o}),this.updateBanners())}onDataActionClicked(e,t){const o=t.dataset.action;this.onActionClickedCore(o)}onPlusActionClicked(e,t){this.onActionClickedCore(e.detail)}onActionClickedCore(e){e?.startsWith("command:")&&this.sendCommand(Ho,{command:e.slice(8)})}getDaysRemaining(){return[_o.FreeInPreviewTrial,_o.FreePlusInTrial].includes(this.state.subscription.state)?Mo(this.state.subscription,"days")??0:0}forceShowPlus(){return[_o.FreePreviewTrialExpired,_o.FreePlusTrialExpired,_o.VerificationRequired].includes(this.state.subscription.state)}updateHeader(e=this.getDaysRemaining(),t=this.forceShowPlus()){const{subscription:o,completedSteps:n,avatar:r,pinStatus:s}=this.state,i=document.getElementById("header-card");if(i){r&&i.setAttribute("image",r),i.setAttribute("name",o.account?.name??"");const a=this.$steps?.length??0;let c=n?.length??0;if(a>0&&c>0){const e=this.$steps.map((e=>e.id)),o=n.filter((t=>e.includes(t)));c=o.length,t&&o.includes("plus")&&(c-=1)}i.setAttribute("steps",a.toString()),i.setAttribute("completed",c.toString()),i.setAttribute("state",o.state.toString()),i.setAttribute("plan",o.plan.effective.name),i.setAttribute("days",e.toString()),i.pinStatus=s}}updateBanners(){const e=[...document.querySelectorAll("[data-banner]")];if(!e.length)return;const{dismissedBanners:t}=this.state;e.forEach((e=>{const o=e.getAttribute("data-banner");null!==o&&t?.includes(o)?e.setAttribute("hidden","true"):e.removeAttribute("hidden")}))}updateNoRepo(){const{extensionEnabled:e}=this.state,t=e?"true":"false";let o=document.getElementById("no-repo");o?.setAttribute("aria-hidden",t),e?o?.setAttribute("hidden",t):o?.removeAttribute("hidden"),o=document.getElementById("no-repo-alert"),o?.setAttribute("aria-hidden",t),e?o?.setAttribute("hidden",t):o?.removeAttribute("hidden")}updateLayout(){const{layout:e}=this.state;[...document.querySelectorAll("[data-gitlens-layout]")].forEach((t=>{const o=t.getAttribute("data-gitlens-layout");t.classList.toggle("is-active",o===e)}))}updatePlusContent(e=this.getDaysRemaining()){const{subscription:t,visibility:o,plusEnabled:n}=this.state;let r=document.getElementById("plus-banner");r&&(r.setAttribute("days",e.toString()),r.setAttribute("state",t.state.toString()),r.setAttribute("visibility",o),r.setAttribute("plan",t.plan.effective.name),r.setAttribute("plus",n.toString()),r.extensionEnabled=this.state.extensionEnabled),r=document.getElementById("plus-content"),r&&(r.setAttribute("days",e.toString()),r.setAttribute("state",t.state.toString()),r.setAttribute("visibility",o),r.setAttribute("plan",t.plan.effective.name))}updateSteps(e=this.forceShowPlus()){null!=this.$steps&&0!==this.$steps.length&&null!=this.state.completedSteps&&0!==this.state.completedSteps.length&&this.$steps.forEach((t=>{t.setAttribute("completed","plus"===t.id&&e||!0!==this.state.completedSteps?.includes(t.id)?"false":"true")}))}updateSections(){null!=this.$cards&&0!==this.$cards.length&&null!=this.state.dismissedSections&&0!==this.state.dismissedSections.length&&this.state.dismissedSections.forEach((e=>{const t=this.$cards.findIndex((t=>t.id===e));t>-1&&(this.$cards[t].remove(),this.$cards.splice(t,1))}))}updateState(){const{completedSteps:e,dismissedSections:t}=this.state;this.updateNoRepo(),this.updateLayout();const o=e?.length||t?.length;document.getElementById("restore-welcome")?.classList.toggle("hide",!o);const n=this.forceShowPlus(),r=this.getDaysRemaining();this.updateHeader(r,n),this.updatePlusContent(r),this.updateSteps(n),this.updateSections(),this.updateBanners()}}function Rr(e=[],t,o=!0){const n=e.includes(t);return!n&&o?e.push(t):n&&!o&&e.splice(e.indexOf(t),1),e}new Or;var Lr=t.z;export{Lr as HomeApp};